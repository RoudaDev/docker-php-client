...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class HostConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\Docker\\Api\\Model\\HostConfig';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\Docker\\Api\\Model\\HostConfig';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\Docker\Api\Model\HostConfig();
            ...
            if (\array_key_exists('BlkioWeightDevice', $data) && $data['BlkioWeightDevice'] !== null) {
                ...
                foreach ($data['BlkioWeightDevice'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'Rouda\\Docker\\Api\\Model\\ResourcesBlkioWeightDeviceItem', 'json', $context);
                }
            ...
            if (\array_key_exists('BlkioDeviceReadBps', $data) && $data['BlkioDeviceReadBps'] !== null) {
                ...
                foreach ($data['BlkioDeviceReadBps'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'Rouda\\Docker\\Api\\Model\\ThrottleDevice', 'json', $context);
                }
            ...
            if (\array_key_exists('BlkioDeviceWriteBps', $data) && $data['BlkioDeviceWriteBps'] !== null) {
                ...
                foreach ($data['BlkioDeviceWriteBps'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'Rouda\\Docker\\Api\\Model\\ThrottleDevice', 'json', $context);
                }
            ...
            if (\array_key_exists('BlkioDeviceReadIOps', $data) && $data['BlkioDeviceReadIOps'] !== null) {
                ...
                foreach ($data['BlkioDeviceReadIOps'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, 'Rouda\\Docker\\Api\\Model\\ThrottleDevice', 'json', $context);
                }
            ...
            if (\array_key_exists('BlkioDeviceWriteIOps', $data) && $data['BlkioDeviceWriteIOps'] !== null) {
                ...
                foreach ($data['BlkioDeviceWriteIOps'] as $value_4) {
                    $values_4[] = $this->denormalizer->denormalize($value_4, 'Rouda\\Docker\\Api\\Model\\ThrottleDevice', 'json', $context);
                }
            ...
            if (\array_key_exists('Devices', $data) && $data['Devices'] !== null) {
                ...
                foreach ($data['Devices'] as $value_5) {
                    $values_5[] = $this->denormalizer->denormalize($value_5, 'Rouda\\Docker\\Api\\Model\\DeviceMapping', 'json', $context);
                }
            ...
            if (\array_key_exists('DeviceRequests', $data) && $data['DeviceRequests'] !== null) {
                ...
                foreach ($data['DeviceRequests'] as $value_7) {
                    $values_7[] = $this->denormalizer->denormalize($value_7, 'Rouda\\Docker\\Api\\Model\\DeviceRequest', 'json', $context);
                }
            ...
            if (\array_key_exists('Ulimits', $data) && $data['Ulimits'] !== null) {
                ...
                foreach ($data['Ulimits'] as $value_8) {
                    $values_8[] = $this->denormalizer->denormalize($value_8, 'Rouda\\Docker\\Api\\Model\\ResourcesUlimitsItem', 'json', $context);
                }
            ...
            if (\array_key_exists('LogConfig', $data) && $data['LogConfig'] !== null) {
                $object->setLogConfig($this->denormalizer->denormalize($data['LogConfig'], 'Rouda\\Docker\\Api\\Model\\HostConfigLogConfig', 'json', $context));
            }
            ...
            if (\array_key_exists('PortBindings', $data) && $data['PortBindings'] !== null) {
                ...
                foreach ($data['PortBindings'] as $key => $value_10) {
                    ...
                    foreach ($value_10 as $value_11) {
                        $values_11[] = $this->denormalizer->denormalize($value_11, 'Rouda\\Docker\\Api\\Model\\PortBinding', 'json', $context);
                    }
            ...
            if (\array_key_exists('RestartPolicy', $data) && $data['RestartPolicy'] !== null) {
                $object->setRestartPolicy($this->denormalizer->denormalize($data['RestartPolicy'], 'Rouda\\Docker\\Api\\Model\\RestartPolicy', 'json', $context));
            }
            ...
            if (\array_key_exists('Mounts', $data) && $data['Mounts'] !== null) {
                ...
                foreach ($data['Mounts'] as $value_13) {
                    $values_13[] = $this->denormalizer->denormalize($value_13, 'Rouda\\Docker\\Api\\Model\\Mount', 'json', $context);
                }
        ...
        {
            return ['Rouda\\Docker\\Api\\Model\\HostConfig' => false];
        }
    }
} else {
    class HostConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
