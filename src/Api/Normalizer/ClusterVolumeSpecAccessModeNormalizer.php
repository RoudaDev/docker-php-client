...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ClusterVolumeSpecAccessModeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\Docker\\Api\\Model\\ClusterVolumeSpecAccessMode';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\Docker\\Api\\Model\\ClusterVolumeSpecAccessMode';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\Docker\Api\Model\ClusterVolumeSpecAccessMode();
            ...
            if (\array_key_exists('Secrets', $data) && $data['Secrets'] !== null) {
                ...
                foreach ($data['Secrets'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'Rouda\\Docker\\Api\\Model\\ClusterVolumeSpecAccessModeSecretsItem', 'json', $context);
                }
            ...
            if (\array_key_exists('AccessibilityRequirements', $data) && $data['AccessibilityRequirements'] !== null) {
                $object->setAccessibilityRequirements($this->denormalizer->denormalize($data['AccessibilityRequirements'], 'Rouda\\Docker\\Api\\Model\\ClusterVolumeSpecAccessModeAccessibilityRequirements', 'json', $context));
            }
            ...
            if (\array_key_exists('CapacityRange', $data) && $data['CapacityRange'] !== null) {
                $object->setCapacityRange($this->denormalizer->denormalize($data['CapacityRange'], 'Rouda\\Docker\\Api\\Model\\ClusterVolumeSpecAccessModeCapacityRange', 'json', $context));
            }
        ...
        {
            return ['Rouda\\Docker\\Api\\Model\\ClusterVolumeSpecAccessMode' => false];
        }
    }
} else {
    class ClusterVolumeSpecAccessModeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
