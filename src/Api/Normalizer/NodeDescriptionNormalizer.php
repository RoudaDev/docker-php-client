...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class NodeDescriptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\Docker\\Api\\Model\\NodeDescription';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\Docker\\Api\\Model\\NodeDescription';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\Docker\Api\Model\NodeDescription();
            ...
            if (\array_key_exists('Platform', $data) && $data['Platform'] !== null) {
                $object->setPlatform($this->denormalizer->denormalize($data['Platform'], 'Rouda\\Docker\\Api\\Model\\Platform', 'json', $context));
            }
            ...
            if (\array_key_exists('Resources', $data) && $data['Resources'] !== null) {
                $object->setResources($this->denormalizer->denormalize($data['Resources'], 'Rouda\\Docker\\Api\\Model\\ResourceObject', 'json', $context));
            }
            ...
            if (\array_key_exists('Engine', $data) && $data['Engine'] !== null) {
                $object->setEngine($this->denormalizer->denormalize($data['Engine'], 'Rouda\\Docker\\Api\\Model\\EngineDescription', 'json', $context));
            }
            ...
            if (\array_key_exists('TLSInfo', $data) && $data['TLSInfo'] !== null) {
                $object->setTLSInfo($this->denormalizer->denormalize($data['TLSInfo'], 'Rouda\\Docker\\Api\\Model\\TLSInfo', 'json', $context));
            }
        ...
        {
            return ['Rouda\\Docker\\Api\\Model\\NodeDescription' => false];
        }
    }
} else {
    class NodeDescriptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
