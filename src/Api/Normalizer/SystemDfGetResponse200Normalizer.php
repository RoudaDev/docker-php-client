...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SystemDfGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\Docker\\Api\\Model\\SystemDfGetResponse200';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\Docker\\Api\\Model\\SystemDfGetResponse200';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\Docker\Api\Model\SystemDfGetResponse200();
            ...
            if (\array_key_exists('Images', $data) && $data['Images'] !== null) {
                ...
                foreach ($data['Images'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'Rouda\\Docker\\Api\\Model\\ImageSummary', 'json', $context);
                }
            ...
            if (\array_key_exists('Containers', $data) && $data['Containers'] !== null) {
                ...
                foreach ($data['Containers'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'Rouda\\Docker\\Api\\Model\\ContainerSummary', 'json', $context);
                }
            ...
            if (\array_key_exists('Volumes', $data) && $data['Volumes'] !== null) {
                ...
                foreach ($data['Volumes'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'Rouda\\Docker\\Api\\Model\\Volume', 'json', $context);
                }
            ...
            if (\array_key_exists('BuildCache', $data) && $data['BuildCache'] !== null) {
                ...
                foreach ($data['BuildCache'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, 'Rouda\\Docker\\Api\\Model\\BuildCache', 'json', $context);
                }
        ...
        {
            return ['Rouda\\Docker\\Api\\Model\\SystemDfGetResponse200' => false];
        }
    }
} else {
    class SystemDfGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
