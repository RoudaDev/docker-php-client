...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ContainerWaitResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\Docker\\Api\\Model\\ContainerWaitResponse';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\Docker\\Api\\Model\\ContainerWaitResponse';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\Docker\Api\Model\ContainerWaitResponse();
            ...
            if (\array_key_exists('Error', $data) && $data['Error'] !== null) {
                $object->setError($this->denormalizer->denormalize($data['Error'], 'Rouda\\Docker\\Api\\Model\\ContainerWaitExitError', 'json', $context));
            }
        ...
        {
            return ['Rouda\\Docker\\Api\\Model\\ContainerWaitResponse' => false];
        }
    }
} else {
    class ContainerWaitResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
