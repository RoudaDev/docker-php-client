...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class NetworkSettingsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\Docker\\Api\\Model\\NetworkSettings';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\Docker\\Api\\Model\\NetworkSettings';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\Docker\Api\Model\NetworkSettings();
            ...
            if (\array_key_exists('Ports', $data) && $data['Ports'] !== null) {
                ...
                foreach ($data['Ports'] as $key => $value) {
                    ...
                    foreach ($value as $value_1) {
                        $values_1[] = $this->denormalizer->denormalize($value_1, 'Rouda\\Docker\\Api\\Model\\PortBinding', 'json', $context);
                    }
                    $values[$key] = $values_1;
                }
            ...
            if (\array_key_exists('SecondaryIPAddresses', $data) && $data['SecondaryIPAddresses'] !== null) {
                ...
                foreach ($data['SecondaryIPAddresses'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'Rouda\\Docker\\Api\\Model\\Address', 'json', $context);
                }
            ...
            if (\array_key_exists('SecondaryIPv6Addresses', $data) && $data['SecondaryIPv6Addresses'] !== null) {
                ...
                foreach ($data['SecondaryIPv6Addresses'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, 'Rouda\\Docker\\Api\\Model\\Address', 'json', $context);
                }
            ...
            if (\array_key_exists('Networks', $data) && $data['Networks'] !== null) {
                ...
                foreach ($data['Networks'] as $key_1 => $value_4) {
                    $values_4[$key_1] = $this->denormalizer->denormalize($value_4, 'Rouda\\Docker\\Api\\Model\\EndpointSettings', 'json', $context);
                }
        ...
        {
            return ['Rouda\\Docker\\Api\\Model\\NetworkSettings' => false];
        }
    }
} else {
    class NetworkSettingsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
