...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ClusterVolumeSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\Docker\\Api\\Model\\ClusterVolumeSpec';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\Docker\\Api\\Model\\ClusterVolumeSpec';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\Docker\Api\Model\ClusterVolumeSpec();
            ...
            if (\array_key_exists('AccessMode', $data) && $data['AccessMode'] !== null) {
                $object->setAccessMode($this->denormalizer->denormalize($data['AccessMode'], 'Rouda\\Docker\\Api\\Model\\ClusterVolumeSpecAccessMode', 'json', $context));
            }
        ...
        {
            return ['Rouda\\Docker\\Api\\Model\\ClusterVolumeSpec' => false];
        }
    }
} else {
    class ClusterVolumeSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
