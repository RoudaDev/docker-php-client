...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TaskSpecContainerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\Docker\\Api\\Model\\TaskSpecContainerSpec';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\Docker\\Api\\Model\\TaskSpecContainerSpec';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\Docker\Api\Model\TaskSpecContainerSpec();
            ...
            if (\array_key_exists('Privileges', $data) && $data['Privileges'] !== null) {
                $object->setPrivileges($this->denormalizer->denormalize($data['Privileges'], 'Rouda\\Docker\\Api\\Model\\TaskSpecContainerSpecPrivileges', 'json', $context));
            }
            ...
            if (\array_key_exists('Mounts', $data) && $data['Mounts'] !== null) {
                ...
                foreach ($data['Mounts'] as $value_5) {
                    $values_5[] = $this->denormalizer->denormalize($value_5, 'Rouda\\Docker\\Api\\Model\\Mount', 'json', $context);
                }
            ...
            if (\array_key_exists('DNSConfig', $data) && $data['DNSConfig'] !== null) {
                $object->setDNSConfig($this->denormalizer->denormalize($data['DNSConfig'], 'Rouda\\Docker\\Api\\Model\\TaskSpecContainerSpecDNSConfig', 'json', $context));
            }
            ...
            if (\array_key_exists('Secrets', $data) && $data['Secrets'] !== null) {
                ...
                foreach ($data['Secrets'] as $value_7) {
                    $values_7[] = $this->denormalizer->denormalize($value_7, 'Rouda\\Docker\\Api\\Model\\TaskSpecContainerSpecSecretsItem', 'json', $context);
                }
            ...
            if (\array_key_exists('Configs', $data) && $data['Configs'] !== null) {
                ...
                foreach ($data['Configs'] as $value_8) {
                    $values_8[] = $this->denormalizer->denormalize($value_8, 'Rouda\\Docker\\Api\\Model\\TaskSpecContainerSpecConfigsItem', 'json', $context);
                }
            ...
            if (\array_key_exists('Ulimits', $data) && $data['Ulimits'] !== null) {
                ...
                foreach ($data['Ulimits'] as $value_12) {
                    $values_12[] = $this->denormalizer->denormalize($value_12, 'Rouda\\Docker\\Api\\Model\\TaskSpecContainerSpecUlimitsItem', 'json', $context);
                }
        ...
        {
            return ['Rouda\\Docker\\Api\\Model\\TaskSpecContainerSpec' => false];
        }
    }
} else {
    class TaskSpecContainerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
