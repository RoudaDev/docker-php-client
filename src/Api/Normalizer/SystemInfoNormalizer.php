...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SystemInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\Docker\\Api\\Model\\SystemInfo';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\Docker\\Api\\Model\\SystemInfo';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\Docker\Api\Model\SystemInfo();
            ...
            if (\array_key_exists('Plugins', $data) && $data['Plugins'] !== null) {
                $object->setPlugins($this->denormalizer->denormalize($data['Plugins'], 'Rouda\\Docker\\Api\\Model\\PluginsInfo', 'json', $context));
            }
            ...
            if (\array_key_exists('RegistryConfig', $data) && $data['RegistryConfig'] !== null) {
                $object->setRegistryConfig($this->denormalizer->denormalize($data['RegistryConfig'], 'Rouda\\Docker\\Api\\Model\\RegistryServiceConfig', 'json', $context));
            }
            ...
            if (\array_key_exists('GenericResources', $data) && $data['GenericResources'] !== null) {
                ...
                foreach ($data['GenericResources'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'Rouda\\Docker\\Api\\Model\\GenericResourcesItem', 'json', $context);
                }
            ...
            if (\array_key_exists('Runtimes', $data) && $data['Runtimes'] !== null) {
                ...
                foreach ($data['Runtimes'] as $key => $value_4) {
                    $values_4[$key] = $this->denormalizer->denormalize($value_4, 'Rouda\\Docker\\Api\\Model\\Runtime', 'json', $context);
                }
            ...
            if (\array_key_exists('Swarm', $data) && $data['Swarm'] !== null) {
                $object->setSwarm($this->denormalizer->denormalize($data['Swarm'], 'Rouda\\Docker\\Api\\Model\\SwarmInfo', 'json', $context));
            }
            ...
            if (\array_key_exists('ContainerdCommit', $data) && $data['ContainerdCommit'] !== null) {
                $object->setContainerdCommit($this->denormalizer->denormalize($data['ContainerdCommit'], 'Rouda\\Docker\\Api\\Model\\Commit', 'json', $context));
            }
            ...
            if (\array_key_exists('RuncCommit', $data) && $data['RuncCommit'] !== null) {
                $object->setRuncCommit($this->denormalizer->denormalize($data['RuncCommit'], 'Rouda\\Docker\\Api\\Model\\Commit', 'json', $context));
            }
            ...
            if (\array_key_exists('InitCommit', $data) && $data['InitCommit'] !== null) {
                $object->setInitCommit($this->denormalizer->denormalize($data['InitCommit'], 'Rouda\\Docker\\Api\\Model\\Commit', 'json', $context));
            }
            ...
            if (\array_key_exists('DefaultAddressPools', $data) && $data['DefaultAddressPools'] !== null) {
                ...
                foreach ($data['DefaultAddressPools'] as $value_6) {
                    $values_6[] = $this->denormalizer->denormalize($value_6, 'Rouda\\Docker\\Api\\Model\\SystemInfoDefaultAddressPoolsItem', 'json', $context);
                }
            ...
            if (\array_key_exists('CDISpecDirs', $data) && $data['CDISpecDirs'] !== null) {
                $values_8 = [];
            ...
            elseif (\array_key_exists('CDISpecDirs', $data) && $data['CDISpecDirs'] === null) {
        ...
        {
            return ['Rouda\\Docker\\Api\\Model\\SystemInfo' => false];
        }
    }
} else {
    class SystemInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
