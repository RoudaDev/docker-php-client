...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TaskSpecPlacementPreferencesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\Docker\\Api\\Model\\TaskSpecPlacementPreferencesItem';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\Docker\\Api\\Model\\TaskSpecPlacementPreferencesItem';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\Docker\Api\Model\TaskSpecPlacementPreferencesItem();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Spread', $data) && $data['Spread'] !== null) {
                $object->setSpread($this->denormalizer->denormalize($data['Spread'], 'Rouda\\Docker\\Api\\Model\\TaskSpecPlacementPreferencesItemSpread', 'json', $context));
            }
        ...
        {
            return ['Rouda\\Docker\\Api\\Model\\TaskSpecPlacementPreferencesItem' => false];
        }
    }
} else {
    class TaskSpecPlacementPreferencesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
