...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ContainerSummaryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\Docker\\Api\\Model\\ContainerSummary';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\Docker\\Api\\Model\\ContainerSummary';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\Docker\Api\Model\ContainerSummary();
            ...
            if (\array_key_exists('Ports', $data) && $data['Ports'] !== null) {
                ...
                foreach ($data['Ports'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'Rouda\\Docker\\Api\\Model\\Port', 'json', $context);
                }
            ...
            if (\array_key_exists('HostConfig', $data) && $data['HostConfig'] !== null) {
                $object->setHostConfig($this->denormalizer->denormalize($data['HostConfig'], 'Rouda\\Docker\\Api\\Model\\ContainerSummaryHostConfig', 'json', $context));
            }
            ...
            if (\array_key_exists('NetworkSettings', $data) && $data['NetworkSettings'] !== null) {
                $object->setNetworkSettings($this->denormalizer->denormalize($data['NetworkSettings'], 'Rouda\\Docker\\Api\\Model\\ContainerSummaryNetworkSettings', 'json', $context));
            }
            ...
            if (\array_key_exists('Mounts', $data) && $data['Mounts'] !== null) {
                ...
                foreach ($data['Mounts'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, 'Rouda\\Docker\\Api\\Model\\MountPoint', 'json', $context);
                }
        ...
        {
            return ['Rouda\\Docker\\Api\\Model\\ContainerSummary' => false];
        }
    }
} else {
    class ContainerSummaryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
